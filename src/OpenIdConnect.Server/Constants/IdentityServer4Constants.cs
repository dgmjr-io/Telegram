...
public static  partial class IdentityServerConstants
{
    ...
    public static readonly IEnumerable<string> SupportedDPoPSigningAlgorithms = new[]
    {
        SecurityAlgorithms.RsaSha256,
        SecurityAlgorithms.RsaSha384,
        SecurityAlgorithms.RsaSha512,
    ...
    {
        public static readonly string Basic = Telegram.OpenIdConnect.Telemetry.TraceNames.Basic;
        public static readonly string Stores = Telegram.OpenIdConnect.Telemetry.TraceNames.Store;
        public static readonly string Cache = Telegram.OpenIdConnect.Telemetry.TraceNames.Cache;
        public static readonly string Validation = Telemetry.TraceNames.Validation;
        public static readonly string Services = Telemetry.TraceNames.Services;

        public static readonly string ServiceVersion = Telemetry.TraceNames.ServiceVersion;
    }
    ...
    public static class ContentSecurityPolicyHashes
    {
        ...
        /// </summary>
        public const string CheckSessionScript =
